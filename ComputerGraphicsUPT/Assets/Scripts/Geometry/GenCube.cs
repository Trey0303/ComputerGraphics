...
public class GenCube : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        verts[4] = new Vector3(width, height, depth);
        verts[5] = new Vector3(0, height, depth);
        verts[6] = new Vector3(width, 0, depth);
        verts[7] = new Vector3(0, 0, depth);
        ...
        //UVs[1] = new Vector2(0, height);
        //UVs[2] = new Vector2(width, 0);
        //UVs[3] = new Vector2(width, height);
        //UVs[4] = new Vector2(width, height);
        //UVs[5] = new Vector2(0, height);
